/*
====================================================================
Stored Procedure: Loading Bronze Layer (Source system -> Bronze)
====================================================================
Script Purpose:
  Stored Procedure that lodas data into the "bronze" schema from external csv files.
  It performs...
  - Truncating the bronze tables before loading data to have a clean slate
  - Uses 'BULK INSERT' command to do a full load of data from CSV files to the bronze tables.
*/
